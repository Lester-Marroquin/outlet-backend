...
const { validar } = require('../schemas/garantia-schema');
const query  = require('../querys/garantia-query');
...
const crear = async (body) => {
  try {
    ...
    return responseSuccess({data: result, message: 'Categoria de garantia creada exitosamente'});
...
const actualizar = async (body, id) => {
  try {
    ...
    return responseSuccess({data: result, message: 'Categoria de garantia actualizada exitosamente'});
