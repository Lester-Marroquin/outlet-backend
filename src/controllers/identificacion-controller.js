...
const { validar } = require('../schemas/identificacion-schema');
const query  = require('../querys/identificacion-query');
...
const crear = async (body) => {
  try {
    ...
    return responseSuccess({data: result, message: 'Tipo de Identificacion creado exitosamente'});
...
const actualizar = async (body, id) => {
  try {
    ...
    return responseSuccess({data: result, message: 'Tipo de Identificacion actualizado exitosamente'});
