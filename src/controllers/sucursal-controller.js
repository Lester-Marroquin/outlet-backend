...
const { validar } = require('../schemas/sucursal-schema');
const query  = require('../querys/sucursal-query');
...
const crear = async (body) => {
  try {
    ...
    return responseSuccess({data: result, message: 'Sucursal creada exitosamente'});
...
const actualizar = async (body, id) => {
  try {
    ...
    return responseSuccess({data: result, message: 'Sucursal actualizada exitosamente'});
